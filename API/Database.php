...
function insert ($table="items", $rows = "", $values)
{
...
else echo json_encode("SQL error: ". $insert);
}



function update ($table="guma", $id, $keys, $values)
{
$set_query = array();
...
function delete ($table="zivotinje",  $key, $value)
{
